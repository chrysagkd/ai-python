...
new_texts = ["Όλο παίζεις, εσύ, κάθε μέρα, εσύ, με το φως του σύμπαντος κόσμου. Επισκέπτρια συλφίδα των νερών και των κήπων. Δεν είσαι δε μόνο εκείνη η χρυσή κεφαλή όπου σαν ανθοδέσμη σφιχτά την κρατάω εγώ μες στα δυο μου τα χέρια. Κανενός αλλουνού δεν μοιάζεις εσύ από τότε που εγώ σε αγάπησα. Άσε να σε ξαπλώσω σ’ ένα στρώμα από μάηδες κίτρινους κι αγαπανθούς. Ποιος είν’ εκείνος εκεί που γράφει τ’ όνομά σου με ψηφία καπνού στ’ αστέρια του Νότου? Εγώ είμ’ εκείνος εκεί που γράφει τ’ όνομά σου με ψηφία καπνού στ’ αστέρια το Νότου! Άσε με… άσε με να σε αναπολήσω όπως ήσουν προτού ν’ ανασπασθείς και βγεις στην ύπαρξη."]
